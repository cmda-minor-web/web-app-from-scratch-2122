...
|  | *Code structure* you write modular, consistent and efficient HTML, CSS and JavaScript code by applying patterns and best practices. You manage state for the application and the UI |  |
